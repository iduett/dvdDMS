 ...
 * class: CLIApp
 * purpose: Provides a command-line interface (CLI) for managing DVDs in the database.
...
public class CLIApp {
     ...
     * return: void
     * purpose: Entry point of the application; creates an instance of CLIApp and starts it.
     */
     ...
     * parameters: none
     * return: void
     * purpose: Prompts the user for DVD details and adds the record to the database.
     */
    private void addDVD() {
        try {
     ...
     * parameters: none
     * return: void
     * purpose: Retrieves and displays all DVDs in the database.
     */
     ...
     * parameters: none
     * return: void
     * purpose: Allows the user to update an existing DVD by its ID.
     */
     ...
     * parameters: none
     * return: void
     * purpose: Removes a DVD from the database by its ID.
     */
     ...
     * parameters: none
     * return: void
     * purpose: Prompts the user for a genre and computes the average rating for that genre.
     */
     ...
     * parameters: none
     * return: void
     * purpose: Imports DVD records from a CSV file into the database.
     */
